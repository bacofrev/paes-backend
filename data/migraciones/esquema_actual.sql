...
--
-- Name: code_text; Type: DOMAIN; Schema: public; Owner: -
--

CREATE DOMAIN public.code_text AS text
	CONSTRAINT code_text_check CHECK ((VALUE ~ '^[A-Z0-9]{2,6}(-[A-Z0-9]+){0,3}$'::text));


--
-- Name: misconception_origin; Type: TYPE; Schema: public; Owner: -
--

CREATE TYPE public.misconception_origin AS ENUM (
    'demre',
    'docente',
    'hipotesis'
);
...
--
-- Name: check_code_matches_area(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_code_matches_area() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
declare v_area text;
begin
...
CREATE FUNCTION public.node_edges_no_cycles() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
  if exists (
...
--
-- Name: recompute_all_mastery(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.recompute_all_mastery() RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare
  n integer := 0;
...
--
-- Name: recompute_node_mastery(uuid, bigint); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.recompute_node_mastery(p_student uuid, p_node bigint) RETURNS void
    LANGUAGE plpgsql
    AS $$
declare
...
CREATE TABLE public.areas (
    id bigint NOT NULL,
    code public.code_text NOT NULL,
    name text NOT NULL,
    "position" smallint NOT NULL,
    status text DEFAULT 'active'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    subject_id bigint NOT NULL,
    CONSTRAINT areas_status_check CHECK ((status = ANY (ARRAY['active'::text, 'retired'::text])))
);
...
COMMENT ON TABLE public.areas IS 'Los ejes del temario: Números, Álgebra y funciones, Geometría, Estadística, Probabilidad. Se llaman areas y no chapters a propósito: no hay orden entre ellos y un estudiante puede ir avanzado en uno y en cero en otro.';
...
CREATE TABLE public.courses (
    ...
    subject_id bigint NOT NULL,
    area_id bigint,
    exam_level smallint NOT NULL,
    "position" smallint NOT NULL,
    status text DEFAULT 'active'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT courses_exam_level_check CHECK (((exam_level >= 1) AND (exam_level <= 2))),
    CONSTRAINT courses_status_check CHECK ((status = ANY (ARRAY['active'::text, 'retired'::text])))
);
...
COMMENT ON TABLE public.courses IS 'Lo que el estudiante cursa, no lo que rinde. La PAES de Ciencias es una sola prueba de 80 preguntas (54 comunes + 26 de la mención), pero alguien puede querer estudiar solo Química. Por eso el curso recorta contenido y no representa un instrumento de evaluación.';


--
-- Name: COLUMN courses.area_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.courses.area_id IS 'null = la asignatura completa. Con valor = solo esa área. Un curso de mención en Física lleva area_id = FIS y exam_level = 2, lo que incluye el nivel 1 de Física: nadie hace mención sin el común de su propia disciplina.';
...
ALTER TABLE public.areas ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.ejes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: item_options; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.item_options (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT item_options_check CHECK ((NOT (is_correct AND (misconception_id IS NOT NULL))))
);
...
CREATE TABLE public.items (
    ...
    CONSTRAINT items_author_difficulty_check CHECK (((author_difficulty >= 1) AND (author_difficulty <= 5))),
    CONSTRAINT items_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'active'::text, 'retired'::text])))
);


--
-- Name: COLUMN items.author_difficulty; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.items.author_difficulty IS 'Dificultad declarada a ojo, 1-5. Sustituto barato hasta tener dificultad estimada por IRT. Permite exigir un piso de dificultad en el criterio de dominio desde el primer día.';
...
--
-- Name: COLUMN lesson_nodes.anchor; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.lesson_nodes.anchor IS 'Id de la sección del markdown que corresponde a este nodo (slug del encabezado de nivel 2). Permite entregar la clase completa o abrirla directo en el pedazo que le falta al estudiante. El cargador verifica que exista como "## " en lessons.body.';
...
CREATE TABLE public.lessons (
    ...
    status text DEFAULT 'draft'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT lessons_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'active'::text, 'retired'::text])))
);
...
COMMENT ON TABLE public.lessons IS 'Contenido expositivo, determinista y versionado. NO es el tutor conversacional y NO es la remediación: la remediación corrige un error ya diagnosticado, la clase enseña por primera vez.';
...
--
-- Name: mastery_config; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.mastery_config (
    version smallint NOT NULL,
    is_active boolean DEFAULT false NOT NULL,
    p_threshold numeric(4,3) NOT NULL,
    min_items smallint NOT NULL,
    min_difficulty smallint NOT NULL,
    min_hard_correct smallint NOT NULL,
    prior_alpha numeric(4,2) DEFAULT 1 NOT NULL,
    prior_beta numeric(4,2) DEFAULT 1 NOT NULL,
...
--
-- Name: misconceptions; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.misconceptions (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    node_id bigint,
    origin public.misconception_origin DEFAULT 'hipotesis'::public.misconception_origin NOT NULL,
    example text,
    CONSTRAINT misconceptions_check CHECK (((status = 'merged'::text) = (merged_into IS NOT NULL))),
    CONSTRAINT misconceptions_check1 CHECK (((merged_into IS NULL) OR (merged_into <> id))),
    CONSTRAINT misconceptions_status_check CHECK ((status = ANY (ARRAY['active'::text, 'merged'::text, 'deprecated'::text])))
);


--
-- Name: COLUMN misconceptions.area_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.misconceptions.area_id IS 'Opcional: solo organiza el catálogo para quien escribe ítems. Hay errores que cruzan ejes y no deben forzarse a uno.';


--
-- Name: COLUMN misconceptions.merged_into; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.misconceptions.merged_into IS 'Válvula de escape: al descubrir que dos códigos eran el mismo error, se marca uno como merged en vez de reetiquetar los ítems. Las respuestas históricas siguen siendo válidas.';


--
-- Name: COLUMN misconceptions.node_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.misconceptions.node_id IS 'El nodo donde este error SE ENSEÑA, que no es lo mismo que dónde APARECE. Un error aparece en varios nodos (eso se sabe siguiendo item_options -> items -> node_items) pero se corrige en uno solo. Sirve para tres cosas: a qué sección de la clase mandar al estudiante cuando el error no tiene remediación escrita, distinguir un error de un nodo futuro de uno del nodo actual, y auditar qué errores de un nodo quedaron sin cubrir. Nullable: hay errores transversales sin un nodo claro.';


--
-- Name: COLUMN misconceptions.origin; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.misconceptions.origin IS 'Procedencia del error. hipotesis = sin evidencia empírica todavía.';


--
-- Name: misconceptions_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.misconceptions ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.misconceptions_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: node_edges; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.node_edges (
    ...
    note text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT node_edges_check CHECK ((prereq_id <> target_id)),
    CONSTRAINT node_edges_status_check CHECK ((status = ANY (ARRAY['hypothesis'::text, 'validated'::text, 'rejected'::text])))
);


--
-- Name: TABLE node_edges; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.node_edges IS 'Toda arista nace como hipótesis. Ordena la ruta, no bloquea. Validación: si A es prerrequisito de B, casi nadie debería dominar B sin dominar A. Si un % alto lo hace, la arista pasa a rejected.';


--
-- Name: node_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.node_items (
    node_id bigint NOT NULL,
    item_id uuid NOT NULL
);
...
CREATE TABLE public.node_mastery (
    ...
    items_answered smallint DEFAULT 0 NOT NULL,
    items_correct smallint DEFAULT 0 NOT NULL,
    hard_correct smallint DEFAULT 0 NOT NULL,
...
CREATE TABLE public.nodes (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    unit_id bigint NOT NULL,
    exam_level smallint DEFAULT 0 NOT NULL,
    CONSTRAINT nodes_exam_level_check CHECK (((exam_level >= 0) AND (exam_level <= 2))),
    CONSTRAINT nodes_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'active'::text, 'retired'::text])))
);


--
-- Name: COLUMN nodes.exam_level; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.nodes.exam_level IS 'Nivel MÁS BAJO de prueba que evalúa este contenido, no pertenencia a un conjunto. Un nodo de nivel 1 también entra en la prueba de nivel 2, porque la avanzada supone la base. Por eso el filtro es <= y no =. Default 0: un nodo nuevo es contenido previo hasta que alguien diga lo contrario, que es el error barato.';
...
--
-- Name: remediation_items; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: remediations; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.remediations (
    ...
    status text DEFAULT 'draft'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT remediations_status_check CHECK ((status = ANY (ARRAY['draft'::text, 'active'::text, 'retired'::text])))
);


--
-- Name: TABLE remediations; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.remediations IS 'Cuelga de la misconcepción, no del nodo: el mismo error aparece en varios nodos y la remediación se escribe una vez. NO es la clase otra vez más corta. NO es el tutor conversacional: es contenido determinista, versionado y auditable.';


--
-- Name: remediations_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.remediations ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.remediations_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.responses (
    ...
    selected_label text,
    session_id uuid NOT NULL,
    context text DEFAULT 'practice'::text NOT NULL,
    response_time_ms integer,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT responses_context_check CHECK ((context = ANY (ARRAY['diagnostic'::text, 'study'::text, 'practice'::text, 'review'::text, 'remediation'::text, 'mock_exam'::text]))),
    CONSTRAINT responses_response_time_ms_check CHECK ((response_time_ms >= 0))
);


--
-- Name: COLUMN responses.option_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.responses.option_id IS 'NULL = omitida. Distinto de incorrecta.';


--
-- Name: COLUMN responses.session_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.responses.session_id IS 'Obligatorio. Toda respuesta pertenece a una sesión: sin ella no hay reporte, no hay modo, y no se puede distinguir un ensayo de práctica suelta.';


--
-- Name: COLUMN responses.context; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.responses.context IS 'diagnostic: medición inicial. study: dentro de una clase. practice: ejercitación libre. review: repaso programado. remediation: después de diagnosticar un error. mock_exam: ensayo cronometrado, sin feedback inmediato. El estimador debe poder ponderar distinto por contexto.';


--
-- Name: COLUMN responses.response_time_ms; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.responses.response_time_ms IS 'Viene del cliente: manipulable. No usar como insumo psicométrico hasta medirlo en servidor.';
...
CREATE TABLE public.sessions (
    ...
    CONSTRAINT sessions_status_check CHECK ((status = ANY (ARRAY['in_progress'::text, 'completed'::text, 'abandoned'::text])))
);
...
COMMENT ON TABLE public.sessions IS 'Bloque de estudio con un propósito único. NO es una sesión de login: esa vive en auth.sessions y la maneja Supabase. Un ingreso a la app puede contener varias sesiones de estudio.';


--
-- Name: COLUMN sessions.mode; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sessions.mode IS 'Interruptor de comportamiento, no metadato. Define de dónde salen los ítems, si el feedback es inmediato o diferido, y cómo termina. diagnostic y mock_exam difieren el feedback porque miden; study, practice y review responden al tiro porque enseñan. No existe modo remediation: la remediación es un tramo DENTRO de una sesión de feedback inmediato, disparado por un error.';


--
-- Name: COLUMN sessions.target_node_id; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sessions.target_node_id IS 'NULL = la sesión cruza varios nodos (diagnostic, mock_exam, review). Sin check por modo a propósito: review puede ser de uno o de varios.';


--
-- Name: COLUMN sessions.planned_item_count; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.sessions.planned_item_count IS 'Cuántos ítems se pensaba servir. Permite calcular omitidas como planned - count(responses) sin llevar un contador que se desincroniza en cada GET /next. NULL en modos abiertos (practice).';
...
CREATE TABLE public.student_courses (
    ...
    status text DEFAULT 'active'::text NOT NULL,
    CONSTRAINT student_courses_status_check CHECK ((status = ANY (ARRAY['active'::text, 'paused'::text, 'finished'::text])))
);


--
-- Name: TABLE student_courses; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.student_courses IS 'Un estudiante puede tener varios cursos a la vez: M2, Lenguaje y Ciencias Física. Su alcance es la UNIÓN de los tres. Esto es lo que las columnas en students no podían representar.';
...
COMMENT ON TABLE public.subjects IS 'La asignatura. NO es la prueba: Matemática tiene dos instrumentos (M1 y M2) y eso vive en exams. Ciencias es el caso que lo aclara: una asignatura, una prueba, con módulos electivos adentro.';
...
CREATE TABLE public.units (
    ...
    status text DEFAULT 'active'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT units_status_check CHECK ((status = ANY (ARRAY['active'::text, 'retired'::text])))
);
...
COMMENT ON TABLE public.units IS 'La unidad del temario: Potencias, Proporcionalidad. Es la palabra que usa DEMRE y la que lee el estudiante en pantalla. Una unidad NO es una clase: las grandes se entregan en varias.';
...
--
-- Name: v_active_misconceptions; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_active_misconceptions AS
 SELECT r.student_id,
   ...
   FROM (((public.responses r
     JOIN public.item_options o ON ((o.id = r.option_id)))
     JOIN public.misconceptions m ON ((m.id = o.misconception_id)))
     LEFT JOIN public.node_items ni ON ((ni.item_id = r.item_id)))
...
--
-- Name: v_node_mastery; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_node_mastery AS
 SELECT nm.student_id,
    n.code AS node_code,
    n.name AS node_name,
    a.code AS area_code,
    nm.p_correct,
   ...
   FROM (((public.node_mastery nm
     ...
     CROSS JOIN LATERAL ( SELECT mastery_config.validity_days
           FROM public.mastery_config
          WHERE (mastery_config.version = nm.config_version)) cfg);


--
-- Name: v_available_nodes; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_available_nodes AS
 SELECT st.id AS student_id,
   ...
   FROM (((((((public.students st
     ...
     JOIN public.areas ar ON ((ar.id = n.area_id)))
     LEFT JOIN public.v_node_mastery vm ON (((vm.student_id = st.id) AND ((vm.node_code)::text = (n.code)::text))))
     LEFT JOIN public.node_edges pre ON ((pre.target_id = n.id)))
     LEFT JOIN public.nodes prn ON ((prn.id = pre.prereq_id)))
     LEFT JOIN public.v_node_mastery pm ON (((pm.student_id = st.id) AND ((pm.node_code)::text = (prn.code)::text))))
...
--
-- Name: VIEW v_available_nodes; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON VIEW public.v_available_nodes IS 'Ojo al costo: es students × nodes. Filtrar siempre por student_id, nunca leerla entera. Un estudiante sin cursos activos no ve ningún nodo, que es lo correcto: no compró nada.';


--
-- Name: v_node_coverage; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_node_coverage AS
 SELECT n.code,
    n.name,
    u.code AS unit_code,
    n.exam_level,
   ...
   FROM ((((public.nodes n
     JOIN public.units u ON ((u.id = n.unit_id)))
     LEFT JOIN public.node_items ni ON ((ni.node_id = n.id)))
     LEFT JOIN public.lesson_nodes ln ON ((ln.node_id = n.id)))
     LEFT JOIN public.item_options io ON (((io.item_id = ni.item_id) AND (io.misconception_id IS NOT NULL))))
  GROUP BY n.code, n.name, u.code, n.exam_level;


--
-- Name: v_responses; Type: VIEW; Schema: public; Owner: -
--

CREATE VIEW public.v_responses AS
 SELECT r.id,
    r.student_id,
    r.created_at,
    r.context,
   ...
   FROM (((public.responses r
     ...
     LEFT JOIN public.item_options o ON ((o.id = r.option_id)))
     LEFT JOIN public.misconceptions m ON ((m.id = o.misconception_id)));
...
--
-- Name: courses courses_subject_id_position_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.courses
    ADD CONSTRAINT courses_subject_id_position_key UNIQUE (subject_id, "position");


--
-- Name: item_options item_options_item_id_label_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.item_options
    ADD CONSTRAINT item_options_item_id_label_key UNIQUE (item_id, label);


--
-- Name: item_options item_options_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
ALTER TABLE ONLY public.lesson_nodes
    ADD CONSTRAINT lesson_nodes_pkey PRIMARY KEY (lesson_id, node_id);


--
-- Name: lessons lessons_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: lessons lessons_unit_id_position_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lessons
    ADD CONSTRAINT lessons_unit_id_position_key UNIQUE (unit_id, "position");


--
-- Name: mastery_config mastery_config_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.mastery_config
    ADD CONSTRAINT mastery_config_pkey PRIMARY KEY (version);


--
-- Name: misconceptions misconceptions_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.misconceptions
    ADD CONSTRAINT misconceptions_code_key UNIQUE (code);


--
-- Name: misconceptions misconceptions_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.misconceptions
    ADD CONSTRAINT misconceptions_pkey PRIMARY KEY (id);


--
-- Name: node_edges node_edges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_edges
    ADD CONSTRAINT node_edges_pkey PRIMARY KEY (prereq_id, target_id);


--
-- Name: node_items node_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_items
    ADD CONSTRAINT node_items_pkey PRIMARY KEY (node_id, item_id);
...
ALTER TABLE ONLY public.node_mastery
    ADD CONSTRAINT node_mastery_pkey PRIMARY KEY (student_id, node_id);


--
-- Name: nodes nodes_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nodes
    ADD CONSTRAINT nodes_code_key UNIQUE (code);
...
--
-- Name: remediation_items remediation_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediation_items
    ADD CONSTRAINT remediation_items_pkey PRIMARY KEY (remediation_id, item_id);


--
-- Name: remediations remediations_code_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediations
    ADD CONSTRAINT remediations_code_key UNIQUE (code);


--
-- Name: remediations remediations_misconception_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediations
    ADD CONSTRAINT remediations_misconception_id_key UNIQUE (misconception_id);


--
-- Name: remediations remediations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediations
    ADD CONSTRAINT remediations_pkey PRIMARY KEY (id);
...
--
-- Name: subjects subjects_position_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.subjects
    ADD CONSTRAINT subjects_position_key UNIQUE ("position");


--
-- Name: node_items un_nodo_por_item; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_items
    ADD CONSTRAINT un_nodo_por_item UNIQUE (item_id);


--
-- Name: units units_area_id_position_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.units
    ADD CONSTRAINT units_area_id_position_key UNIQUE (area_id, "position");
...
--
-- Name: item_options_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX item_options_item ON public.item_options USING btree (item_id);


--
-- Name: item_options_misconception; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX item_options_misconception ON public.item_options USING btree (misconception_id);


--
-- Name: lesson_nodes_node; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX lesson_nodes_node ON public.lesson_nodes USING btree (node_id);


--
-- Name: mastery_config_one_active; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX mastery_config_one_active ON public.mastery_config USING btree (is_active) WHERE is_active;


--
-- Name: misconceptions_node_id_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX misconceptions_node_id_idx ON public.misconceptions USING btree (node_id);


--
-- Name: node_mastery_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX node_mastery_status ON public.node_mastery USING btree (status);


--
-- Name: node_mastery_student; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX node_mastery_student ON public.node_mastery USING btree (student_id);


--
-- Name: nodes_exam_level_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX nodes_exam_level_idx ON public.nodes USING btree (exam_level);


--
-- Name: one_key_per_item; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX one_key_per_item ON public.item_options USING btree (item_id) WHERE is_correct;


--
-- Name: responses_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX responses_item ON public.responses USING btree (item_id);
...
CREATE INDEX responses_session ON public.responses USING btree (session_id);


--
-- Name: responses_student_created; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX responses_student_created ON public.responses USING btree (student_id, created_at DESC);


--
-- Name: sessions_student_started; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX sessions_student_started ON public.sessions USING btree (student_id, started_at DESC);


--
-- Name: sessions_una_abierta_por_student; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX sessions_una_abierta_por_student ON public.sessions USING btree (student_id) WHERE (status = 'in_progress'::text);


--
-- Name: student_courses_course; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX student_courses_course ON public.student_courses USING btree (course_id);
...
CREATE TRIGGER node_edges_acyclic BEFORE INSERT OR UPDATE ON public.node_edges FOR EACH ROW EXECUTE FUNCTION public.node_edges_no_cycles();


--
-- Name: nodes nodes_code_area; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER nodes_code_area BEFORE INSERT OR UPDATE ON public.nodes FOR EACH ROW EXECUTE FUNCTION public.check_code_matches_area();


--
-- Name: units units_code_area; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER units_code_area BEFORE INSERT OR UPDATE ON public.units FOR EACH ROW EXECUTE FUNCTION public.check_code_matches_area();
...
--
-- Name: areas areas_subject_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.areas
    ADD CONSTRAINT areas_subject_id_fkey FOREIGN KEY (subject_id) REFERENCES public.subjects(id);


--
-- Name: courses courses_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.courses
    ADD CONSTRAINT courses_area_id_fkey FOREIGN KEY (area_id) REFERENCES public.areas(id);
...
--
-- Name: item_options item_options_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.item_options
    ADD CONSTRAINT item_options_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id) ON DELETE RESTRICT;


--
-- Name: item_options item_options_misconception_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.item_options
    ADD CONSTRAINT item_options_misconception_id_fkey FOREIGN KEY (misconception_id) REFERENCES public.misconceptions(id);
...
--
-- Name: lesson_nodes lesson_nodes_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.lesson_nodes
    ADD CONSTRAINT lesson_nodes_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.nodes(id);
...
--
-- Name: misconceptions misconceptions_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.misconceptions
    ADD CONSTRAINT misconceptions_area_id_fkey FOREIGN KEY (area_id) REFERENCES public.areas(id);


--
-- Name: misconceptions misconceptions_merged_into_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.misconceptions
    ADD CONSTRAINT misconceptions_merged_into_fkey FOREIGN KEY (merged_into) REFERENCES public.misconceptions(id);


--
-- Name: misconceptions misconceptions_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.misconceptions
    ADD CONSTRAINT misconceptions_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.nodes(id);


--
-- Name: node_edges node_edges_prereq_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_edges
    ADD CONSTRAINT node_edges_prereq_id_fkey FOREIGN KEY (prereq_id) REFERENCES public.nodes(id);


--
-- Name: node_edges node_edges_target_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_edges
    ADD CONSTRAINT node_edges_target_id_fkey FOREIGN KEY (target_id) REFERENCES public.nodes(id);


--
-- Name: node_items node_items_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_items
    ADD CONSTRAINT node_items_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id) ON DELETE RESTRICT;


--
-- Name: node_items node_items_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_items
    ADD CONSTRAINT node_items_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.nodes(id);


--
-- Name: node_mastery node_mastery_config_version_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_mastery
    ADD CONSTRAINT node_mastery_config_version_fkey FOREIGN KEY (config_version) REFERENCES public.mastery_config(version);
...
ALTER TABLE ONLY public.node_mastery
    ADD CONSTRAINT node_mastery_node_id_fkey FOREIGN KEY (node_id) REFERENCES public.nodes(id);


--
-- Name: node_mastery node_mastery_student_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.node_mastery
    ADD CONSTRAINT node_mastery_student_id_fkey FOREIGN KEY (student_id) REFERENCES public.students(id) ON DELETE CASCADE;


--
-- Name: nodes nodes_area_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.nodes
    ADD CONSTRAINT nodes_area_id_fkey FOREIGN KEY (area_id) REFERENCES public.areas(id);
...
--
-- Name: remediation_items remediation_items_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediation_items
    ADD CONSTRAINT remediation_items_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id) ON DELETE RESTRICT;


--
-- Name: remediation_items remediation_items_remediation_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediation_items
    ADD CONSTRAINT remediation_items_remediation_id_fkey FOREIGN KEY (remediation_id) REFERENCES public.remediations(id);


--
-- Name: remediations remediations_misconception_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.remediations
    ADD CONSTRAINT remediations_misconception_id_fkey FOREIGN KEY (misconception_id) REFERENCES public.misconceptions(id);
...
ALTER TABLE ONLY public.responses
    ADD CONSTRAINT responses_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.items(id) ON DELETE RESTRICT;


--
-- Name: responses responses_option_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.responses
    ADD CONSTRAINT responses_option_id_fkey FOREIGN KEY (option_id) REFERENCES public.item_options(id) ON DELETE RESTRICT;


--
-- Name: responses responses_session_fk; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.responses
    ADD CONSTRAINT responses_session_fk FOREIGN KEY (session_id) REFERENCES public.sessions(id) ON DELETE CASCADE;
...
--
-- Name: sessions sessions_target_node_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.sessions
    ADD CONSTRAINT sessions_target_node_id_fkey FOREIGN KEY (target_node_id) REFERENCES public.nodes(id);
...
ALTER TABLE ONLY public.units
    ADD CONSTRAINT units_area_id_fkey FOREIGN KEY (area_id) REFERENCES public.areas(id);
...
--
-- Name: item_options; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: mastery_config; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.mastery_config ENABLE ROW LEVEL SECURITY;

--
-- Name: misconceptions; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.misconceptions ENABLE ROW LEVEL SECURITY;

--
-- Name: node_edges; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.node_edges ENABLE ROW LEVEL SECURITY;

--
-- Name: node_items; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.node_items ENABLE ROW LEVEL SECURITY;

--
-- Name: node_mastery; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: remediation_items; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.remediation_items ENABLE ROW LEVEL SECURITY;

--
-- Name: remediations; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: student_courses; Type: ROW SECURITY; Schema: public; Owner: -
--
